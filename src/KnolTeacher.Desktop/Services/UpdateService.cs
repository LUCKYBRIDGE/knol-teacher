...
public class UpdateService : IUpdateService
{
    ...
    private const string LatestReleaseApi = "https://api.github.com/repos/LUCKYBRIDGE/knol-teacher/releases/latest";
